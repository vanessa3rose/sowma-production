 ...
 * Central configuration for which charts exist per social platform.
 * Used by:
 *  - SocialMediaPage (rendering charts + picking metrics)
 *  - ExportModal (platform selection)
 *  - Hidden export pages (full-page PDF exports)
 */
export const CHART_CONFIGS = {
  instagram: [
    { id: "impressions",       title: "Impressions",        type: "line", metric: "VIEWS" },
  ...
  twitter: [
    { id: "followers_count",   title: "Followers",          type: "line", metric: "FOLLOWERS" },
    { id: "following_count",   title: "Following",          type: "line", metric: "LIKES" },      // adjust if needed
    { id: "tweet_count",       title: "Tweet Count",        type: "line", metric: "POSTS" },
 ...
 * (Still useful if you ever go back to chart-level exporting.)
>>>>>>> 0eb8d39 (Initial Proposal)
 */
