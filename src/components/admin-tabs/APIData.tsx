...
const SOCIAL_MEDIA_METRICS = [
    {
        ...
        metrics: ["Active Users", "Page Views", "Engagement Rate", "New Users",
                "Bounce Rate", "Avg Session Duration", "Total Session", "Engaged Sessions", "Pages / Session", "Engagement Time"],
    },
    {
        socialMedia: "Instagram",
        metrics: ["Likes", "Comments", "Days Posted", "Followers", "Reach", "Views", "Total Interactions"],
    },
    {
...
export default function APIData() {
    ...
    const selectedPlatform = SOCIAL_MEDIA_METRICS.find((p) => p.socialMedia === platform);
    return (
        <div className="p-6 flex flex-col">
            <h2 className="text-2xl text-gray-500 font-bold font-poppins">Manual Data Entry</h2>
            ...
            <div className="font-poppins font-[400] text-2xl grid grid-rows gap-6 py-6">
                ...
                <div className="flex items-center gap-6">
                    <p className="text-gray-500">Which metric would you like to change?</p>
                    <select
                        value={metric}
