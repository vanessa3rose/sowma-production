...
const SmallCard: React.FC<SmallCardProps> = ({
  ...
  const shouldShowMetric = displayMode === 'both' || displayMode === 'metric-only';
  ...
  return (
    ...
    >
      ...
      <div className={shouldShowChart ? "flex items-start justify-between" : ""}>
                ...
                <div className="flex items-center gap-1">
                  <span 
                    style={{
                      ...
                      lineHeight: '100%',
                      letterSpacing: '0%',
                      color: metricChange.includes('increase') || metricChange.startsWith('+') ? '#10B981' : metricChange.includes('decrease') || metricChange.startsWith('-') ? '#EF4444' : '#10B981'
                    }}
                  >
                    {metricChange}
                  </span>
                  {(metricChange.includes('increase') || metricChange.startsWith('+')) && (
                    <svg 
