      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <LoginTextBox
            label="Password:"
            placeholder="••••••••••"
            type={showPassword ? "text" : "password"} // Allows the user to toggle password visibility
            icon={
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)} // Turns the icon into a button that toggles showPassword
