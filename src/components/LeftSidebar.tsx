  ...
  return (
    <>
      ...
      <div className={sidebarClasses}>
        ...
        {/* Links */}
        <div className="flex flex-col w-4/5 items-start space-y-3 mt-4 px-1">
          <a href="/">
            <div className="bg-light-gray flex flex-row items-center gap-x-4 px-2 py-1 rounded hover:bg-gray-100">
              <svg
          ...
          <a href="/admin">
            <div className="bg-light-gray flex flex-row items-center gap-x-4 px-2 py-1 rounded hover:bg-gray-100">
              ...
              <p className="hidden lg:block font-poppins font-medium text-[20px]">
                Admin
              </p>
            </div>
          </a>
